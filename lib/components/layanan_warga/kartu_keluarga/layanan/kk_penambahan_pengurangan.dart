...
class KKPenambahanPengurangan extends StatefulWidget {
  const KKPenambahanPengurangan({super.key});

  @override
  State<KKPenambahanPengurangan> createState() =>
      _KKPenambahanPenguranganState();
}

class _KKPenambahanPenguranganState extends State<KKPenambahanPengurangan> {
  @override
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'KK Penambahan/Pengurangan Jiwa',
                    style: GoogleFonts.roboto(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                    ),
                  ...
                  Text(
                    '2. Akta Kelahiran/Akta Kematian',
                    style: GoogleFonts.roboto(fontSize: 14),
                  ),
                  Text(
                    '3. Dibawa Langsung ke Kantor atau Disdukcapil',
                    style: GoogleFonts.roboto(fontSize: 14),
                  ),
                ],
              ),
