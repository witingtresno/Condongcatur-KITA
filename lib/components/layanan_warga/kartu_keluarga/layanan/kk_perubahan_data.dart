...
class KKPerubahanData extends StatefulWidget {
  const KKPerubahanData({super.key});

  @override
  State<KKPerubahanData> createState() => _KKPerubahanDataState();
}

class _KKPerubahanDataState extends State<KKPerubahanData> {
  @override
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '2. FotoKopi Bukti Perubahan (Kutipan Akta Nikah/Ijazah/Akta Kelahiran)',
                    style: GoogleFonts.roboto(fontSize: 14),
                  ),
                  Text(
                    '3. Mengisi Form F1.06 (Disediakan Kantor)',
                    style: GoogleFonts.roboto(fontSize: 14),
                  ),
                ],
              ),
