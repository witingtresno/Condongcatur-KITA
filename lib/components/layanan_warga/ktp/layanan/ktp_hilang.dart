...
class KtpHilang extends StatefulWidget {
  const KtpHilang({super.key});

  @override
  State<KtpHilang> createState() => _KtpHilangState();
}

class _KtpHilangState extends State<KtpHilang> {
  @override
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Datang langsung ke Kantor dengan membawa: ',
                    style: GoogleFonts.roboto(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                    ),
                  ...
                  const SizedBox(height: 8),
                  Text(
                    '1. Surat Kehilangan dari Polsek atau Polres\n'
