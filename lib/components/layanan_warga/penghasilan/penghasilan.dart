...
class Penghasilan extends StatelessWidget {
  const Penghasilan({super.key});
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '4. Nomor Handphone Kedua belah pihak',
                    style: GoogleFonts.roboto(fontSize: 14),
                  ),
                  const SizedBox(
                    height: 10,
                  ...
                  Text(
                    'Pelayanan Gugat Cerai dilayani setiap hari Rabu\n'
                    '(dengan perjanjian lebih dahulu)\n',
                    style: GoogleFonts.roboto(fontSize: 14),
                  ),
                ],
              ),
