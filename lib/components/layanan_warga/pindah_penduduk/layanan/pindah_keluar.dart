...
class PindahKeluar extends StatefulWidget {
  const PindahKeluar({super.key});

  @override
  State<PindahKeluar> createState() => _PindahKeluarState();
}

class _PindahKeluarState extends State<PindahKeluar> {
  @override
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'A. PINDAH KELUAR ANTAR KALURAHAN\n'
                    '   KK dan KTP Asli dibawa ke Kapanewon Sewon\n'
                    '   (Tanpa Pengantar dari Kalurahan)\n',
                    style: GoogleFonts.roboto(fontSize: 14),
                  ),
                  Text(
                    'B. PINDAH KELUAR ANTAR KAPANEWON\n'
                    '   KK dan KTP Asli dibawa ke Kapanewon Sewon\n'
                    '   (Tanpa Pengantar dari Kalurahan)\n',
                    style: GoogleFonts.roboto(fontSize: 14),
                  ),
                  Text(
                    'C. PINDAH KELUAR ANTAR KABUPATEN/KOTA\n'
                    '   KK dan KTP Asli dibawa ke Disdukcapil Kabupaten Bantul\n'
                    '   (Tanpa Pengantar dari Kalurahan ataupun Kapanewon)\n',
                    style: GoogleFonts.roboto(fontSize: 14),
                  ),
                ],
              ),
