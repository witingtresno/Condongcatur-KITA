...
class TalakGugatCerai extends StatelessWidget {
  const TalakGugatCerai({super.key});
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '2. Fotokopi KK dan KTP Penggugat',
                    style: GoogleFonts.roboto(fontSize: 14),
                  ),
                  Text(
                    '3. Fotokopi KK dan KTP tergugat',
                    style: GoogleFonts.roboto(fontSize: 14),
                  ),
                  Text(
                    '4. Menyertakan alasan permohonan Talak/Gugat Cerai',
                    style: GoogleFonts.roboto(fontSize: 14),
                  ),
                ],
              ),
